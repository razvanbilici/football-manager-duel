...
import com.football.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/player-teams/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/formations/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/tactics/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/user-teams/**").permitAll()
