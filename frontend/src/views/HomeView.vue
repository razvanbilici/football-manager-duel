...
<template>
  <div class="relative min-h-screen space-y-8">
    
    <!-- VIDEO PE TOT FUNDALUL PAGINII -->
    <video
      :src="bgVideo"
      autoplay
      loop
    ...
    <div class="relative z-10 space-y-8">
      ...
      <section class="text-center py-20 relative overflow-hidden">
        <!-- Mingea de pe fundalul secțiunii -->
        <span style="position: absolute; font-size: 12rem; opacity: 0.04; top: 50%; left: 50%; transform: translate(-50%, -50%); pointer-events: none; user-select: none; line-height: 1; z-index: 0;">⚽</span>
        ...
        <div style="position: relative; z-index: 1;">
          ...
          <p class="max-w-xl mx-auto text-base" style="color: #e6edf3;">
            Construiește-ți echipa de vis, cumpără jucători de la cluburile mari
            și concurează cu comunitatea.
          </p>
          <div v-if="!auth.isLoggedIn" class="mt-8 flex gap-4 justify-center">
            <router-link
              to="/register"
            ...
            <router-link
              to="/players"
              class="px-6 py-2.5 rounded-lg text-sm transition-colors"
              style="border: 1px solid var(--border); color: #e6edf3; background: rgba(13, 17, 23, 0.5);">
              Vezi jucătorii
            </router-link>
          </div>
