...
// Importăm videoclipul pentru echipă din assets
import bgVideo from '../assets/team.mp4'
        ...
        <section class="mb-6">
          ...
          <div class="grid lg:grid-cols-[1fr_300px] gap-6 items-start">
            ...
            <div class="rounded-xl p-4" style="background: var(--bg-surface); border: 1px solid var(--border)">
              ...
              <div class="space-y-2 max-h-[480px] overflow-y-auto pr-1" style="scrollbar-width: thin; scrollbar-color: var(--bg-elevated) transparent;">
...
<style scoped>
/* Păstrăm stilurile curate ale aplicației */
</style>